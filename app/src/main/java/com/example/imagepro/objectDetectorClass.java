...
public class objectDetectorClass {
    ...
    public void setSensor_3(int sensor_3) {
    ...
    public void setLed_3(int led_3) {
        this.led_3 = led_3;
    }
        ...
        for (int i=0;i<3;i++){
            ...
            if(score_value>0.8){
                ...
                if(class_value == 0) {
                    ...
                    Imgproc.rectangle(rotated_mat_image,new Point(right,top),new Point(right + 270,top + 120),new Scalar(0, 255, 0, 255),-1);

                    Imgproc.putText(rotated_mat_image, labelList.get((int) class_value)
                            , new Point(right+5, top + 30), 2, 1.2, new Scalar(255, 255, 255, 255), 2);
                    Imgproc.putText(rotated_mat_image, "cam bien: " + sensor_1
                            , new Point(right+5, top + 70), 2, 1, new Scalar(255, 255, 255, 255), 2);
                    Imgproc.putText(rotated_mat_image,  "trang thai: " + led_1
                            , new Point(right+5, top + 110), 2, 1, new Scalar(255, 255, 255, 255), 2);
                }
                if(class_value == 1) {
                    Imgproc.rectangle(rotated_mat_image,new Point(left,top),new Point(right,bottom),new Scalar(255, 0, 0, 255),2);
                    Imgproc.rectangle(rotated_mat_image,new Point(right,top),new Point(right + 270,top + 120),new Scalar(255, 0, 0, 255),-1);

                    Imgproc.putText(rotated_mat_image, labelList.get((int) class_value)
                            , new Point(right+5, top + 30), 2, 1.2, new Scalar(255, 255, 255, 255), 2);
                    Imgproc.putText(rotated_mat_image, "cam bien: " + sensor_2
                            , new Point(right+5, top + 70 ), 2, 1, new Scalar(255, 255, 255, 255), 2);
                    Imgproc.putText(rotated_mat_image, "trang thai: " + led_2
                            , new Point(right+5, top + 110), 2, 1, new Scalar(255, 255, 255, 255), 2);
                }
                if(class_value == 2){
                    Imgproc.rectangle(rotated_mat_image,new Point(left,top),new Point(right,bottom),new Scalar(0, 0, 255, 255),2);
                    Imgproc.rectangle(rotated_mat_image,new Point(right,top),new Point(right + 270,top + 120),new Scalar(0, 0, 255, 255),-1);
                    Imgproc.putText(rotated_mat_image,labelList.get((int) class_value)
                            ,new Point(right+5,top + 30),2,1.2,new Scalar(255, 255, 255, 255),2);
                    Imgproc.putText(rotated_mat_image,"cam bien: " +sensor_3
                            ,new Point(right+5,top + 70),2,1,new Scalar(255, 255, 255, 255),2);
                        Imgproc.putText(rotated_mat_image,"trang thai: " + led_3
                                ,new Point(right+5,top + 110),2,1,new Scalar(255, 255, 255, 255),2);
                }
            }
